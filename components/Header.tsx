...
export default function Header() {
  ...
  useEffect(() => {
    ...
    // Update measurement on resize/orientation changes
  ...
  return (
    <>
      <header
        ref={headerRef}
        className="sticky top-0 z-40 border-b border-white/10 bg-white/0 backdrop-blur supports-[backdrop-filter]:bg-white/5"
      >
        {/* Top Bar (desktop) */}
        <div
      ...
      {/* Portal-rendered mobile overlay + panel (ensures reliable viewport layering) */}
      {mobilePortal}
    </>
  );
}
