// components/residential/ui.ts
// Design tokens shared across the residential section.
// Mirrors the commercial system; warmer gold accent for residential pages.
...
export const residential = {
  ...
  glow:
    ...
    "[background:radial-gradient(900px_480px_at_12%_8%,rgba(212,165,116,0.18),transparent_60%),radial-gradient(800px_500px_at_92%_12%,rgba(15,163,107,0.14),transparent_65%)] " +
  ...
  /* Typography */
  eyebrow:
    "text-[11px] font-medium uppercase tracking-[0.28em] text-[#D4A574]/95",
  h1:
  ...
  numeral:
    "font-display tabular text-5xl sm:text-6xl text-[#D4A574]/35 leading-none",
