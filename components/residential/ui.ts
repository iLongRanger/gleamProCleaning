...
export const residential = {
  /**
   * Full-page shell (match homepage and commercial)
   * Use as OUTERMOST wrapper on residential pages
   */
  ...
  accent: "text-[#D4A574]", // Warmer gold for residential
  muted: "text-white/70",
  body: "text-white/80",
  ...
  secondary:
    "inline-flex items-center justify-center rounded-full border border-[#D4A574] px-6 py-3 text-sm font-semibold text-[#D4A574] transition hover:bg-white/10",
  ctaLight:
