...
export const metadata: Metadata = {
  title: "Commercial Cleaning in Metro Vancouver | Gleam Pro Cleaning",
  description:
    "Reliable commercial cleaning for restaurants, offices, and community facilities across Metro Vancouver. Clear scope, repeatable checklists, and consistent results.",
};
